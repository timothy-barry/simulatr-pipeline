...
#initialize benchmarking results data frame
benchmarking_results <- data.frame(method = character(), seconds = numeric(), bytes = numeric())
...
# benchmark running of this method based on seconds and memory
...
# add to benchmarking results data frame
benchmarking_results <- data.frame(row_idx = row_idx,
                                   method = method,
                                   seconds = seconds,
                                   bytes = bytes)

# save the benchmarking information
saveRDS(benchmarking_results, "method_benchmarking_info.rds")
